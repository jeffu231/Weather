...
/* global define:true*/
define(['amplify', 'dataservices/model.dataserviceAPI', 'dataservices/dataservice.utility'], function (amplify, dsModel, dsUtil) {

	var url = '/jtwx-web/api/v1/samples/outdoor/latest';
